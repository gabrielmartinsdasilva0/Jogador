# JogadorCrie um programa que tenta adivinhar a carta que o jogador está pensando. Ele deve exibir uma mensagem inicial, convidando o usuário a pensar em uma carta do baralho.
